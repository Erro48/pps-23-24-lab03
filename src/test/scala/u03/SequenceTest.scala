...
class SequenceTest:
  ...
  @Test def testConcat() =
    ...
    assertEquals(Cons(40, Cons(50, Nil())), l2.concat(Nil()))
    assertEquals(Nil(), Nil().concat(Nil()))
  ...
  @Test def testFlatMap() =
    ...
    assertEquals(
      Cons(10, Cons(10, Cons(20, Cons(20, Cons(30, Cons(30, Nil())))))),
      flatMap(l)(v => Cons(v, Cons(v, Nil())))
    ) // 10, 10, 20, 20, 30, 30
    assertEquals(
      Cons(11, Cons(21, Cons(31, Nil()))),
      flatMap(l)(v => Cons(v + 1, Nil()))
  ...
  @Test def testTeacherCourses() =
    val l: Sequence[Person] =
      Cons(
        Teacher("Mirko", "PPS"),
        Cons(Student("Mario", 2022), Cons(Teacher("Alessandro", "PCD"), Nil()))
      )
